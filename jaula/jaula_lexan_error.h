...
/*
 * jaula_lexan_error.h : JSON Analysis User Library Acronym
 * Lexical Analysis exception definitions
 *
 ...
 * svn info:
 * $Author: morongo $
 * $HeadURL: file:///svn/p/jaula/code/trunk/jaula/jaula_lexan_error.h $
 * $Id: jaula_lexan_error.h 45 2009-01-11 16:17:03Z morongo $
 * $Revision: 45 $
 */

#ifndef _JAULA_LEXAN_ERROR_H_
#define _JAULA_LEXAN_ERROR_H_
...
{                                // namespace JAULA
  ...
  /**
   * \brief class for lexical analysis exceptions
   *
   * \ingroup jaula_exc
   *
   * \par
   ...
   */
  class Lexan_Error : public Exception
  {                              // class Lexan_Error
    public:
       ...
       * JAULA::LEXAN_ERROR code.
       */
      Lexan_Error(std::string const &detail = ""
...
// EOF $Id: jaula_lexan_error.h 45 2009-01-11 16:17:03Z morongo $
